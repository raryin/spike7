...
class World(object):
    def __init__(self, cx, cy):
        ...
        self.botAlignmentFactor = 1.0
        self.botCohesionFactor = 1.4
        self.botSeparationFactor = 1.0
    ...
    def render(self):
        ...
        if self.show_info:
            ...
            alignFactText = "Alignment Factor(a,s): "+str(agent.AlignmentFactor)
            cohFactText = "Cohesion Factor(z,x): "+str(agent.CohesionFactor)
            sepFactText = "Separation Factor(c,v): "+str(agent.SeparationFactor)
            agent = self.agents[0]
